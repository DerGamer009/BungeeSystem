# BungeeSystem API Integration

Diese Dokumentation erklärt, wie du das BungeeSystem mit dem Dashboard API verbindest.
...
```yaml
# Server Token Configuration for BungeeSystem API
server:
...
```
[INFO] API Manager initialized with token: Bung***1234
...
- **Präfix:** "BungeeSystem_" für einfache Identifikation

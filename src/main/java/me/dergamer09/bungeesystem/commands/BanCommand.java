...
public class BanCommand extends Command implements TabExecutor {
    ...
    public BanCommand(BungeeSystem plugin) {
        super("ban", "bungeesystem.command.ban", "gban", "tempban");
        this.plugin = plugin;
    ...
    private void listAvailableReasons(CommandSender sender) {
        ...
        for (Map<String, Object> reason : reasons) {
            ...
            component.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, 
                    "/ban " + (sender instanceof ProxiedPlayer ? "" : "playerName ") + id));
    ...
    public Iterable<String> onTabComplete(CommandSender sender, String[] args) {
        if (args.length == 1) {
            ...
            // Tab complete ban reasons
            String search = args[1].toLowerCase();
            List<String> reasons = new ArrayList<>();
            
            // Add reason IDs and names
            for (Map<String, Object> reason : punishmentManager.getReasons("BAN")) {
